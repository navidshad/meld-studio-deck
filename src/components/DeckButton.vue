...
<template>
  <div class="relative group/deck h-full">
    <button @click="emit('click')"
      class="w-full h-full glass-card rounded-xl p-2 flex flex-col items-center justify-center gap-2 relative overflow-hidden active:scale-95 group transition-all duration-200 outline-none ring-0 focus:outline-none focus:ring-0 cursor-pointer"
      :class="{
